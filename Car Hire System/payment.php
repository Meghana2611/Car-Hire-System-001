      ...
      <form method="POST">
        ...
        <div class="card__row">
          ...
          <div class="card__col card__chip">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYCLpG6Rlhr9Y7GuF_c2iMGTkq7iyrylF6nlyEwGKTOw&s" alt="chip" />
          </div>
        </div>
        <div class="card__row">
          <div class="card__col">
          ...
          <div class="card__col">
            <label for="cardCvv" class="card__label">CCV</label
            ><input
              type="password"
              class="card__input"
              id="cardCvv"
